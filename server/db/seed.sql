...
VALUES
('Symphony Cake', 'American', 'https://i1.wp.com/www.dutchcountrykitchen.com/wp-content/uploads/2019/08/Chocolate-Symphony-Cake.jpg?fit=1920%2C1280&ssl=1', 'The best cake to ever exist.  You will experience a Symphony in your mouth. This cake is incredibly easy to make, and will make you the most popular at the family reunion!', 'Bake the cake according to the directions on the package (use the Whole Milk, Eggs, and Vanilla Extract for this part). Let the cake cool for 5 minutes and then poke holes all along the top of the cake (a fork works well for this part). Then immediately pour the Sweetened Condensed Milk over the cake. Let the cake cool for 2 hours, or until completely cooled. 30 minutes before cake is done cooling, pull out the Cool Whip from the fridge to bring almost to room temperature. Divide the Symphony Bar into a section of 9 pieces, and a section of 4-5 pieces. Then melt 9 pieces of the Symphony Bar in the microwave until just melted. Let it cool while stirring, for 30 seconds or so. Whip the melted chocolate into the Cool Whip until very well combined. Frost the cooled cake with the Cool Whip mixture. Shave the rest of the Symphony Bar with a veggie peeler over the frosted cake. Refrigerate overnight for best results.', 'This cake was created by Linda Meadows. I don`t think she had the original idea, but this version is certainly her own concoction.'),
